...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Category::create(['name' => 'Men Single', 'gender' => 'M', 'isTeam' => 0, 'ageCategory' => 5, 'ageMin' => '18']);
        Category::create(['name' => 'Men Team', 'gender' => 'M', 'isTeam' => 1, 'ageCategory' => 5, 'ageMin' => '18']);

        Category::create(['name' => 'Ladies Single', 'gender' => 'F', 'isTeam' => 0, 'ageCategory' => 5, 'ageMin' => '18']);
        Category::create(['name' => 'Ladies Team', 'gender' => 'F', 'isTeam' => 1, 'ageCategory' => 5, 'ageMin' => '18']);

        Category::create(['name' => 'Master', 'gender' => 'F', 'isTeam' => 0, 'ageCategory' => 5, 'ageMin' => '50', 'gradeMin' => '8']); // 8 = Shodan
