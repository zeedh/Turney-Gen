  ...
  <div class="offcanvas-md offcanvas-start offcanvas-60 d-md-flex flex-column p-0 pt-3 overflow-y-auto h-100"
    ...
    <div class="offcanvas-body p-0">
      <ul class="nav flex-column mb-2">
        ...
        @auth
        @if(auth()->user()->email === 'zidan@gmail.com')
            <li class="nav-item action">
              <a class="nav-link px-4 py-2 d-flex align-items-center gap-2 {{ Request::is('dashboard/admin*') ? 'active bg-warning text-white' : 'text-dark' }}" href="/dashboard/admin">
                <i class="bi bi-tags-fill text-warning"></i> Admin
              </a>
            </li>
        @endif
        @endauth
